...
public class Revision {
	...
	public Revision(String newText, String oldText, String revisingUser) {
		...
		differences.diff_cleanupSemantic(modifications);	// ignore trivial differences
		...
		for (Diff diff : modifications) {
			...
			case INSERT:
				//TODO: need to parse the insert to see if it inserts a html formatting tag, then categorize it as a formatting modification 
				String insert = "inserted the text: " + "\"" + diff.text + "\"";
				revisingActions.add(insert);
				break;
			case DELETE:
				//TODO: need to parse the deletion to see if it deletes a html formatting tag, then categorize it as a formatting modification 
	...
	public String toString() {
		String toPrint = "At " + getEditTime().getHour()%12 + ":" + getEditTime().getMinute() 
								+ " on " + getEditDate()  + ", " +   revisingUser + " made the following edits:\n";
